...
public class RaceManager : MonoBehaviour
{
    ...
    public void CreateRace(PlayerController player, string chosenRoute, float secondsForWait, int numberOfLaps, int raceCapacity)
    {
        JoinRace(player, chosenRoute, secondsForWait, numberOfLaps, raceCapacity);
    }
    ...
    public void JoinRace(PlayerController player, string route, float secondsForWait = 0, int numberOfLaps = 0, int raceCapacity = 0)
    {
        ...
        foreach (Race race in races)
        {
            ...
            switch (race.state)
            {
                ...
                case RaceState.Inactive:
                    ...
                    // Form new race
                    race.FormRace(player, secondsForWait, numberOfLaps, raceCapacity);
                    break;
